  Pod::Spec.new do |s|
  s.name             = "AFNetworking"
  s.version          = "4.0.1-93b63552493af1216492375fb80afdaa"
  s.summary          = "AFNetworking"
  s.homepage         = "https://github.com/744831110/example_spec_bin_dev.git"
  s.license          = 'Code is MIT, then custom font licenses.'
  s.author           = { "Orta" => "orta.therox@gmail.com" }
  s.source           = { :http => 'https://ios-cache-framework-1258699659.cos.ap-guangzhou.myqcloud.com/AFNetworking/4.0.1/93b63552493af1216492375fb80afdaa/AFNetworking.zip' }
