  Pod::Spec.new do |s|
  s.name             = "Moya"
  s.version          = "13.0.1-b543a57df0c7591e2464d14e9bf20ed7"
  s.summary          = "Moya"
  s.homepage         = "https://github.com/744831110/example_spec_bin_dev.git"
  s.license          = 'Code is MIT, then custom font licenses.'
  s.author           = { "Orta" => "orta.therox@gmail.com" }
  s.source           = { :http => 'https://ios-cache-framework-1258699659.cos.ap-guangzhou.myqcloud.com/Moya/13.0.1/b543a57df0c7591e2464d14e9bf20ed7/Moya.zip' }
