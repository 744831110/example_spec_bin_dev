  Pod::Spec.new do |s|
  s.name             = "MYLCommonUI"
  s.version          = "0.0.11-d9d16927abc0182267379f07de973361"
  s.summary          = "MYLCommonUI"
  s.homepage         = "https://github.com/744831110/example_spec_bin_dev.git"
  s.license          = 'Code is MIT, then custom font licenses.'
  s.author           = { "Orta" => "orta.therox@gmail.com" }
  s.source           = { :http => 'https://ios-cache-framework-1258699659.cos.ap-guangzhou.myqcloud.com/MYLCommonUI/0.0.11/d9d16927abc0182267379f07de973361/MYLCommonUI.zip' }

  s.platform     = :ios, '9.0'
  s.vendored_frameworks = 'MYLCommonUI.framework'
