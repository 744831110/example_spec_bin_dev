  Pod::Spec.new do |s|
  s.name             = "Result"
  s.version          = "4.1.0-Result"
  s.summary          = "Result"
  s.homepage         = "https://github.com/744831110/example_spec_bin_dev.git"
  s.license          = 'Code is MIT, then custom font licenses.'
  s.author           = { "Orta" => "orta.therox@gmail.com" }
  s.source           = { :http => 'https://ios-cache-framework-1258699659.cos.ap-guangzhou.myqcloud.com/Result/4.1.0/Result/Result.zip' }

  s.platform     = :ios, '9.0'
  s.vendored_frameworks = 'Result.framework'
